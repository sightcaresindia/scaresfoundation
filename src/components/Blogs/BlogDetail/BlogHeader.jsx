...
const BlogHeader = (props) => {
    return (
        <div className="breadcumb-area" style={{ background: `url('${process.env.NEXT_PUBLIC_IMAGE_URL}/${props.bgImage}')  no-repeat center top / cover`}}>
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <div className="breadcumb-wrap">
                            <h3>{props.pageTitle ? props.pageTitle : ''}</h3>
                        </div>
                    </div>
                </div>
            </div>
