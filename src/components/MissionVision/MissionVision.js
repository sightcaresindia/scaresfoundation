...
import Img1 from '/public/images/mission-vission/mission-vision.jpg'
import Img2 from '/public/images/mission-vission/mission.jpg'
import Img3 from '/public/images/mission-vission/vision.jpg'
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5 col-12">
                            <div className="service-left">
                                <div class="text-box">
                                    <h3>Our Mission</h3>
                                    <p>To provide comprehensive eye care support to underserved communities, restoring sight and improving quality of life.</p>
                                </div>
                                 <div class="text-box">
                                    <h3>Our Vision</h3>
                                    <p>A future where no one in India suffers from preventable blindness due to lack of access or awareness.</p>
                                </div>
                                <div className="shape">
